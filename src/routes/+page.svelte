<div class="w-full h-screen bg-neutral-950 text-white flex justify-center items-center">
  <nav class="text-center flex items-center justify-center gap-4">
    ...
    <a href="/institute" class="block px-6 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg transition-colors">Institutes</a>
    <a href="/course" class="block px-6 py-2 bg-red-600 hover:bg-red-700 rounded-lg transition-colors">Courses</a>
    <a href="/teacher" class="block px-6 py-2 bg-yellow-600 hover:bg-yellow-700 rounded-lg transition-colors">Teacher</a>
  </nav>
</div>
